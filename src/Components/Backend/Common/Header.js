                ...
                <nav className="navbar navbar-expand">
                    ...
                    <div className="top-menu-left d-none d-lg-block">
                        <ul className="nav">
                            <li className="nav-item">
                                <a className="nav-link" href="app-emailbox.html"><i
                                    className='bx bx-envelope'></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="app-chat-box.html"><i
                                    className='bx bx-message'></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="app-fullcalender.html"><i
                                    className='bx bx-calendar'></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="app-to-do.html"><i
                                    className='bx bx-check-square'></i></a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div className="header-notifications-list">
                                        ...
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
                                                <div className="notify bg-light-danger text-danger"><i
                                                    className="bx bx-message-detail"></i>
                                                </div>
                                                <div className="flex-grow-1">
                                        ...
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
                                                <div className="notify bg-light-success text-success"><i
                                                    className='bx bx-check-square'></i>
                                                </div>
                                                <div className="flex-grow-1">
                                    ...
                                    <div className="header-message-list">
                                        ...
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
												...
												ago</span></h6>
                                                    <p className="msg-info">Various versions have evolved
                                                        over</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
												...
												min ago</span></h6>
                                                    <p className="msg-info">Making this the first true
                                                        generator</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
												...
												ago</span></h6>
                                                    <p className="msg-info">Duis aute irure dolor in
                                                        reprehenderit</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
												...
												ago</span></h6>
                                                    <p className="msg-info">The passage is attributed to an
                                                        unknown</p>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a className="dropdown-item" href="javascript:;">
                                            <div className="d-flex align-items-center">
												...
												ago</span></h6>
                                                    <p className="msg-info">If you are going to use a
                                                        passage</p>
                                                </div>
                                            </div>
                                        </a>
                    ...
                    <div className="user-box dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a className="dropdown-item" href="javascript:;"><i
                                className='bx bx-home-circle'></i><span>Dashboard</span></a>
                            </li>
                            <li><a className="dropdown-item" href="javascript:;"><i
                                className='bx bx-dollar-circle'></i><span>Earnings</span></a>
                            </li>
                            <li><a className="dropdown-item" href="javascript:;"><i
                                className='bx bx-download'></i><span>Downloads</span></a>
                            </li>
                            <li>
